-- Добавление примеров вариантов для существующих продуктов

-- Варианты для пицц (размер и тесто)
-- Сначала создаем типы вариантов для пицц
INSERT INTO product_variant_types (name, product_id, is_required, display_order)
SELECT 'Размер', id, true, 1
FROM products 
WHERE title LIKE '%пицца%' OR title IN (
